...
Write-Host "  IP:        192.168.1.54"
Write-Host "  Proxmox:   https://${ProxmoxHost}:8006"
Write-Host ""
Write-Host "Web Interfaces:"
Write-Host "  Netboot.xyz: http://192.168.1.54:3000"
Write-Host ""
Write-Host "Next Steps:"
Write-Host "  1. Visit http://192.168.1.54:3000 to configure netboot.xyz"
Write-Host "  2. Set up DHCP/PXE (TFTP server: 192.168.1.54)"
