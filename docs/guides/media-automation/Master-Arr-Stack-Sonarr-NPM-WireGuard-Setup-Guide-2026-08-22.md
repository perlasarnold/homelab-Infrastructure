...
flowchart TD
    ...
    subgraph "Cebu Proxmox Node (VLAN 1 [Management])"
        ...
        HostMount["Host Mount (/mnt/plex1/Share)\n//VLAN 1 [Management]/Seagate"]
    end

    subgraph "Synology NAS (VLAN 1 [Management])"
...
### Root Cause
- When the Arr stack container was migrated to **SERVICES VLAN 110** (`VLAN 110 (Services)`), Prowlarr application sync and Sonarr's indexer database entries were still hardcoded to the old IP (`VLAN 1 (Management):9696`).
