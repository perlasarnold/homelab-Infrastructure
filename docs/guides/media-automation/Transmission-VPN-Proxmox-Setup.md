...
Since your Arr stack (Radarr, Sonarr, Prowlarr) is running as separate LXC containers on the local `192.168.1.0/24` network, they need to communicate with Transmission's RPC API.
