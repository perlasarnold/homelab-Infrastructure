...
| :--- | :--- | :--- | :--- |
| **Proxmox Node** | Bulakan (`VLAN 1 [Management]`) | Dapitan (`VLAN 1 [Management]`) | Cebu (`VLAN 1 [Management]`) |
...
1. On Bulakan Proxmox host (`VLAN 1 [Management]`), pause or stop CT 110:
   ```bash
   pct stop 110
   ```
