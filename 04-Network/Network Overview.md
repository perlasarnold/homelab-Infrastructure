...
> **Gateway:** `VLAN 1 [Gateway]` (Perlas-UnifiGW) | **Subnet:** `192.168.1.0/24`
> **Primary DNS:** `VLAN 1 [DNS-Primary]` (PX-Pihole Bulakan) | **Secondary DNS:** `VLAN 1 [DNS-Secondary]` (pihole-cebu)
...
| `VLAN 1 [DNS-Primary]` | pihole (CT 301) | Primary DNS Ad-blocker & Local Resolver | VLAN 1 (Mgmt) | 🟢 Active |
| `VLAN 1 [DNS-Secondary]` | pihole-cebu (CT 401) | Secondary DNS Failover Resolver | VLAN 1 (Mgmt) | 🟢 Active |
| `VLAN 1 [MGMT-NAS]` | PNAS | Synology NAS (23TB CIFS/NFS Shared Storage) | VLAN 1 (Mgmt) | 🟢 Active |
| `VLAN 1 [MGMT-NAS]` | PNAS2 | Secondary Synology (Backup Storage) | VLAN 1 (Mgmt) | 🟢 Active |
| `VLAN 1 [MGMT]` | Bulakan | Proxmox VE Primary Hypervisor Node | VLAN 1 (Mgmt) | 🟢 Active |
| `VLAN 1 [MGMT]` | Cebu | Proxmox VE Secondary Hypervisor Node | VLAN 1 (Mgmt) | 🟢 Active |
| `VLAN 1 [MGMT]` | Dapitan | Proxmox VE Bulk Storage Node (18TB ZFS) | VLAN 1 (Mgmt) | 🟢 Active |
| `VLAN 1 (Mgmt)` | plex (CT 104) | Primary Plex Media Server (Bulakan ZFS) | VLAN 1 (Mgmt) | 🟢 Active |
| `VLAN 1 (Mgmt)` | audiobookshelf (CT 100) | Audiobook library & streaming server | VLAN 1 (Mgmt) | 🟢 Active |
| `VLAN 1 (Mgmt)` | haos-17.3 (VM 111) | Home Assistant OS Controller (Dapitan) | VLAN 1 (Mgmt) | 🟢 Active |
...
|:---|:---|:---|:---|
| Primary | `VLAN 1 [DNS-Primary]` | Bulakan (CT 301: pihole) | 🟢 Active |
| Secondary | `VLAN 1 [DNS-Secondary]` | Cebu (CT 401: pihole-cebu) | 🟢 Active |
...
|:-----|:-----|:-------|:--------|:--------|
| 1 | Default | `192.168.1.0/24` | `VLAN 1 [Gateway]` | Legacy Management & Native Workloads |
| 10 | MGMT | `VLAN 10 (MGMT/SecOps)/24` | `VLAN 10 (MGMT/SecOps)` | Hypervisor Hosts, Switches, APs, Storage DSM/Web GUIs |
