...
def main():
    print("==================================================================")
    print(" Configuring Proxmox API Credentials & Widgets in Homepage (CT 116)")
    print("==================================================================")

    # 1. Update /opt/homepage/config/services.yaml in CT 116
    ...
    # 2. Restart Homepage container to reload services.yaml
    print("\n[+] Restarting Homepage container in CT 116...")
    run_ssh(f"pct exec {VMID} -- bash -c 'cd /opt/homepage && docker-compose restart'")

    time.sleep(5)
    print("\n==================================================================")
    print(" SUCCESS: Proxmox API Widgets Configured!")
    print(" Token ID: homepage-monitoring@pve!token-id")
    print(" Token Secret: 9a861457-a95b-48f6-8ce9-691e52b1a7e4")
    print(" You can now refresh http://home.homelab-admin.me to see live stats!")
    print("==================================================================")
