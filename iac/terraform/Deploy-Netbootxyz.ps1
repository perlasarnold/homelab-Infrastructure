...
Write-Host "  IP:        VLAN 1 [Management]"
Write-Host "  Proxmox:   https://${ProxmoxHost}:8006"
Write-Host ""
Write-Host "Web Interfaces:"
Write-Host "  Netboot.xyz: http://VLAN 1 [Management]:3000"
Write-Host ""
Write-Host "Next Steps:"
Write-Host "  1. Visit http://VLAN 1 [Management]:3000 to configure netboot.xyz"
Write-Host "  2. Set up DHCP/PXE (TFTP server: VLAN 1 [Management])"
