...
prompt_var IP_ADDR "Container IP Address (CIDR)" "${IP_ADDR:-VLAN 110 (Services)/24}"
prompt_var GATEWAY "Network Gateway" "${GATEWAY:-VLAN 110 (Services)}"
prompt_var DNS_SERVER "DNS Server" "${DNS_SERVER:-VLAN 1 [Primary DNS]}"
