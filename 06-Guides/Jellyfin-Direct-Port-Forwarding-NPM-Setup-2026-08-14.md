...
> **Local DNS:** Pi-hole (`VLAN 1 [DNS-Primary]`)  
...
Configure your UniFi Router (`VLAN 1 [Gateway]` / UniFi Network Application) to forward incoming WAN traffic on ports 80/443 directly to your Nginx Proxy Manager LXC (`VLAN 1 (Mgmt)`).
...
- **From**: `Any`
- **Port**: `443`
- **Forward IP**: `VLAN 1 (Mgmt)` (Nginx Proxy Manager LXC)
- **Forward Port**: `443`
- **Protocol**: `TCP`
