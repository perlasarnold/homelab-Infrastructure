...
Home Router / Gateway (VLAN 1 [Gateway])
       │
       ├── VLAN 1 [Management]  →  Proxmox Bulakan (Primary Node)
       │                       └── Core LXC Containers & VMs
       │
       ├── VLAN 1 [Management]  →  Proxmox Cebu (Secondary Node)
       │                       └── Authentik, NPM (Active), Wazuh SIEM
       │
       ├── VLAN 1 [Management]  →  Proxmox Dapitan (Storage & Media Node)
       │                       ├── 18TB ZFS Bulk Storage (/mnt/bindmounts)
       │                       └── Immich, Plex DP, Jellyfin DP
       │
       └── VLAN 1 [Management]  →  PNAS Synology (Shared PVE Storage)
```
...
|--------|----|------|--------|
| Proxmox Bulakan | `VLAN 1 [Management]` | Primary Hypervisor | https://VLAN 1 [Management]:8006 |
| Proxmox Cebu | `VLAN 1 [Management]` | Secondary Hypervisor | https://VLAN 1 [Management]:8006 |
| Proxmox Dapitan | `VLAN 1 [Management]` | Bulk Storage Hypervisor | https://VLAN 1 [Management]:8006 |
| PNAS Synology | `VLAN 1 [Management]` | Network Attached Storage | https://VLAN 1 [Management]:5001 |
