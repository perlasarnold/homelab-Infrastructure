...
After the Proxmox **Bulakan** server (`VLAN 1 [MGMT]`) was rebooted, the Plex Media Server, Jellyfin, and Audiobookshelf containers could not connect to their mounted drives. Synology storage (`PNAS` at `VLAN 1 [MGMT-NAS]`) was verified online and accessible from other hosts on the network.
...
#### Diff of `/etc/fstab`
```diff
- //VLAN 1 [MGMT-NAS]/PlexMediaStorage /mnt/plex cifs username=Plex,password=Media2023!@#,uid=1000,gid=1000,file_mode=0777,dir_mode=0777 0 0
- //VLAN 1 [MGMT-NAS]/Seagate /mnt/plex1 cifs username=Plex,password=Media2023!@#,uid=1000,gid=1000,file_mode=0777,dir_mode=0777 0 0
- //VLAN 1 [MGMT-NAS]/photo /mnt/pnas_photos cifs username=homelab-admin,password=Jiggu1ot!@#,uid=1000,gid=1000,file_mode=0777,dir_mode=0777,noperm 0 0
- //VLAN 1 [MGMT-NAS]/Media/Audiobooks /mnt/audiobooks cifs username=homelab-admin,password=Jiggu1ot!@#,iocharset=utf8,vers=3.0,noperm 0 0
+ //VLAN 1 [MGMT-NAS]/PlexMediaStorage /mnt/plex cifs username=Plex,password=Media2023!@#,uid=1000,gid=1000,file_mode=0777,dir_mode=0777,_netdev,nofail,x-systemd.automount 0 0
+ //VLAN 1 [MGMT-NAS]/Seagate /mnt/plex1 cifs username=Plex,password=Media2023!@#,uid=1000,gid=1000,file_mode=0777,dir_mode=0777,_netdev,nofail,x-systemd.automount 0 0
+ //VLAN 1 [MGMT-NAS]/photo /mnt/pnas_photos cifs username=homelab-admin,password=Jiggu1ot!@#,uid=1000,gid=1000,file_mode=0777,dir_mode=0777,noperm,_netdev,nofail,x-systemd.automount 0 0
+ //VLAN 1 [MGMT-NAS]/Media/Audiobooks /mnt/audiobooks cifs username=homelab-admin,password=Jiggu1ot!@#,iocharset=utf8,vers=3.0,noperm,_netdev,nofail,x-systemd.automount 0 0
```
