...
The original Synology NAS at `VLAN 1 [Management]` remained healthy. Its `Seagate` share was already mounted on Cebu at `/mnt/plex1`, with the media collection beneath `/mnt/plex1/Share`.

## Steps Taken

1. Verified that `VLAN 1 [Management]` responded to ping and accepted SMB connections on TCP 445.
