...
Master index of all running services in the Perlas-Net Homelab.  
...
| Service | CT ID | VLAN / Subnet | IP Address | Status | Purpose |
|:---|:---:|:---:|:---:|:---:|:---|
| Authentik | 103 | VLAN 110 (Services) | `192.168.110.225` | 🟢 Running | Identity Provider & SSO (`auth.perlasarnold.me`) |
| Nginx Proxy Manager (Cebu) | 105 | VLAN 120 (DMZ) | `192.168.120.211` | 🟢 Running | **Primary Reverse Proxy & Wildcard SSL** |
| fail2ban & Dashboard | 406 | VLAN 10 (SecOps) | `192.168.10.50` | 🟢 Running | Intrusion Prevention & Dashboard (`fail2ban.perlasarnold.me`) |
| Tailscale Router/Exit Node | 407 | VLAN 1 (Mgmt) | `192.168.1.246` | 🟢 Running | Mesh VPN Subnet Router & Exit Node |
| Grafana Dashboard | 418 | VLAN 110 (Services) | `192.168.110.60` | 🟢 Running | Observability & Metrics (`grafana.perlasarnold.me`) |
| Uptime Kuma Monitor | 419 | VLAN 110 (Services) | `192.168.110.61` | 🟢 Running | Service Uptime & Alerting (`kuma.perlasarnold.me`) |
...
| Jellyfin (Cebu) | 416 | VLAN 110 (Services) | `192.168.110.46` | 🟢 Running | Standby Failover Jellyfin |
| Arr Stack Consolidated | 417 | VLAN 110 (Services) | `192.168.110.42` | 🟢 Running | Sonarr/Radarr/Prowlarr/qBittorrent/Bindery (Surfshark WireGuard + Gluetun Sidecar) |
...
| BookOrbit | 514 | VLAN 110 (Services) | `192.168.110.50` | 🟢 Running | E-book Library Sync (`bookorbit.perlasarnold.me`) |
...
- BookOrbit → https://bookorbit.perlasarnold.me (Dapitan CT 514 — `192.168.110.50:3000`)

### 📥 Downloads / Arr Stack
- Sonarr → https://sonarr.perlasarnold.me (Cebu CT 417 — `192.168.110.42:8989`)
- Readarr → https://readarr.perlasarnold.me (Cebu CT 417 — `192.168.110.42:8787`)
- Radarr → https://radarr.perlasarnold.me (Cebu CT 417 — `192.168.110.42:7878`)
- Bazarr → http://192.168.110.42:6767 (Cebu CT 417)
- Prowlarr → http://192.168.110.42:9696 (Cebu CT 417)
- qBittorrent → https://torrent.perlasarnold.me (Cebu CT 417 — `192.168.110.42:8080`, Gluetun VPN Sidecar)
- Transmission → *(⚪ Decommissioned / Archived 2026-08-31)*
...
- Photoview → Dapitan CT 511 (`https://photoview.perlasarnold.me`) | Source: `\\pnas\photo` (SMB)
