...
1. Open https://VLAN 1 [Management]:8006
...
.\Download-LXCTemplate.ps1 -ProxmoxHost VLAN 1 [Management]
```
...
| **VM ID** | 118 |
| **Name** | netbootxyz |
| **IP** | VLAN 1 [Management]/24 (static) |
...
3. Access Web UI at http://VLAN 1 [Management]:3000
