...
| :--- | :--- | :---: | :---: | :---: | :--- |
| **Bulakan (Primary)** | Intel i5-9500T (UHD 630) | `104` | `VLAN 1 [Management]:32400` | Intel QSV + `/dev/shm` (16GB RAM) | Synology NAS (`PNAS`) SMB `/mnt/plex` & `/mnt/plex1` |
| **Cebu (High Perf)** | Intel i5-10500T (UHD 630) | `109` | `VLAN 1 [Management]:32400` | Intel QSV + `/dev/shm` (16GB RAM) | Synology NAS (`PNAS`) SMB `/mnt/plex` & `/mnt/plex1` |
