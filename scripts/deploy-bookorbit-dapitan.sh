...
# Node: Dapitan (VLAN 1 [MGMT]) | Host Storage Mount: /mnt/bindmounts/ebooks
...
DNS_SERVER="${DNS_SERVER:-1.1.1.1 VLAN 1 [DNS-Secondary]}"
SYNOLOGY_SHARE="${SYNOLOGY_SHARE:-//VLAN 1 [MGMT-NAS]/Media/Ebooks}"
