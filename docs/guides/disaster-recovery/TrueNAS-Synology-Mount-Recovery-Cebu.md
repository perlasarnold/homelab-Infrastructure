...
After the Proxmox **Cebu** server (`VLAN 1 [MGMT]`) booted, the Plex Media Server and Jellyfin-Cebu containers could not connect to their mounted drives. The CIFS storage hosts (TrueNAS VM at `VLAN 1 (Mgmt)` and Synology NAS at `VLAN 1 [MGMT-NAS]`) were verified online and accessible from other network devices.
...
- //VLAN 1 [MGMT-NAS]/PlexMediaStorage /mnt/plex cifs username=Plex,password=Media2023!@#,uid=1000,gid=1000,file_mode=0777,dir_mode=0777,nofail 0 0
- //VLAN 1 [MGMT-NAS]/Seagate /mnt/plex1 cifs username=Plex,password=Media2023!@#,uid=1000,gid=1000,file_mode=0777,dir_mode=0777,nofail 0 0
...
- //VLAN 1 (Mgmt)/seagate/Share /mnt/truenas/seagate cifs credentials=/etc/samba/credentials-seagate,iocharset=utf8,vers=3.0,uid=100000,gid=100000,file_mode=0775,dir_mode=0775,nofail 0 0
+ //VLAN 1 (Mgmt)/seagate/Share /mnt/cebu-seagate cifs credentials=/etc/samba/credentials-seagate,iocharset=utf8,vers=3.0,nofail,_netdev,x-systemd.automount 0 0
+ //VLAN 1 [MGMT-NAS]/PlexMediaStorage /mnt/plex cifs username=Plex,password=Media2023!@#,uid=1000,gid=1000,file_mode=0777,dir_mode=0777,nofail,_netdev,x-systemd.automount 0 0
+ //VLAN 1 [MGMT-NAS]/Seagate /mnt/plex1 cifs username=Plex,password=Media2023!@#,uid=1000,gid=1000,file_mode=0777,dir_mode=0777,nofail,_netdev,x-systemd.automount 0 0
+ //VLAN 1 (Mgmt)/photo /mnt/truenas-photo cifs credentials=/etc/samba/credentials-seagate,iocharset=utf8,uid=100999,gid=100991,file_mode=0777,dir_mode=0777,nofail,_netdev,x-systemd.automount 0 0
+ //VLAN 1 (Mgmt)/seagate/Share /mnt/truenas/seagate cifs credentials=/etc/samba/credentials-seagate,iocharset=utf8,vers=3.0,uid=100000,gid=100000,file_mode=0775,dir_mode=0775,nofail,_netdev,x-systemd.automount 0 0
```
