...
- [[Dapitan-Plex-Setup-Recovery-2026-07-24]] — Restoring inaccessible Dapitan Plex Media Server CT 509 with static IP VLAN 1 (Management) and 18TB ZFS media library mount
- [[Dapitan-Jellyfin-Replication-Guide-2026-07-24]] — Replicating Cebu Jellyfin to Dapitan CT 510 with IP VLAN 1 (Management) and 18TB ZFS media library mount
