...
> **Container ID:** 118 | **IP:** VLAN 1 (Mgmt) | **Web UI:** http://VLAN 1 (Mgmt):3000
...
Access the web UI: http://VLAN 1 (Mgmt):3000
...
1. Navigate to `http://VLAN 1 (Mgmt):3000`
...
kernel http://VLAN 1 (Mgmt)/netboot.xyz.lkrn
boot
```
...
| Network connectivity? | `ping VLAN 1 (Mgmt)` from client |
