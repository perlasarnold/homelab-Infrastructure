...
> **Node:** Bulakan (`VLAN 1 [MGMT]`) — Homelab-Net Cluster  
...
1. Navigate to `https://VLAN 1 [MGMT]:8006`
...
| Service | URL |
|---------|-----|
| Proxmox UI | https://VLAN 1 [MGMT]:8006 |
| Pi-Hole | http://VLAN 1 [DNS-Primary]/admin |
| Plex | http://VLAN 1 (Mgmt):32400 |
| Jellyfin | http://VLAN 1 (Mgmt):8096 |
| Audiobookshelf | http://VLAN 1 (Mgmt) |
